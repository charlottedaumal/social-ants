...
void FinalApplication::onEvent(sf::Event event, sf::RenderWindow&)
{
    if (event.type == sf::Event::KeyReleased) {
        ...
        case sf::Keyboard::T:
            ...
            break;
        case sf::Keyboard::Z:
            saveMap(getResPath() + getAppConfig().map_saved_name) ;
            break;
        case sf::Keyboard::C:
            getAppEnv().setTemperature(getAppConfig().simulation_low_temperature); ;
            break;
        case sf::Keyboard::F:
            getAppEnv().setTemperature(getAppConfig().simulation_high_temperature); ;
            break;
        case sf::Keyboard::N:
            getAppEnv().setTemperature(getAppConfig().simulation_usual_temperature); ;
            break;
        }
